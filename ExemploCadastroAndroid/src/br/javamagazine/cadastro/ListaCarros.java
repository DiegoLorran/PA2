...
public class ListaCarros extends ListActivity {
  ...
  private void atualizarLista() {
    ...
    // Necessário utilizar um Handler para atualizar a view dentro de uma thread diferente da principal
  ...
  public boolean onMenuItemSelected(int featureId, MenuItem item) {
    ...
    switch (item.getItemId()) {
      case ATUALIZAR:
        ...
        break;
      case FORMULARIO:
        // Abre a tela com o formulário para inserir um novo carro
